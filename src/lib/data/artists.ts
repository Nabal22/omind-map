...
const productionArtists: Artist[] = [
	{
		id: 'yeat',
		name: 'Yeat',
...
export const artists: Artist[] = [...productionArtists];

if (import.meta.env.DEV) {
	// Dynamic import so the test data file is dropped from production bundle.
	const { testArtists } = await import('./artists.test');
	artists.push(...testArtists);
}
