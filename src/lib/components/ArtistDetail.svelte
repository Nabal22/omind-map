...
<div
	class="fixed inset-x-4 bottom-4 z-50 border border-pink/30 bg-black/90 p-4 font-mono text-pink backdrop-blur-sm sm:inset-auto sm:left-6 sm:top-6 sm:max-w-sm sm:border-pink/20 sm:bg-black/80"
